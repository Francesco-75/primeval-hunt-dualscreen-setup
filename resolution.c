...
int initResolutionPatches()
{
    ...
    switch (gId)
    {
        ...
        case PRIMEVAL_HUNT:
        {
            ...
            // Usare < invece di <= per permettere 1280x480 (dual screen nativo)
            // Con TwinView nvidia il display logico è 1280x480 e gWidth=1280
            // soddisferebbe <= 1280 bloccando il dual screen mode.
